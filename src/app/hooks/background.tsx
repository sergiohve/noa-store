...
const GridDistortion: React.FC<GridDistortionProps> = ({
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uDataTexture: {
        value: null as THREE.DataTexture | null,
      },
    };
    ...
    const animate = () => {
      ...
      if (
        !(dataTexture.image.data instanceof Float32Array)
      ) {
        console.error(
          "dataTexture.image.data is not a Float32Array"
        );
        return;
      }
