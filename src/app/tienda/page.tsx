      ...
      <main className="relative z-10 mx-auto pt-3 pb-12 mt-40 max-w-6xl px-4 lg:px-5">
        <div className="mb-6 text-sm">
          <nav className="text-gray-600">
            <Link href="/" className="hover:text-[#90D116]">Inicio</Link>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-1/4">
            <div className="bg-white p-5 rounded-lg shadow-md">
              ...
              <div className="mb-6">
                <h3 className="font-semibold mb-3 text-gray-700">Factor de Potencia</h3>
              ...
              <div className="mb-6">
                <h3 className="font-semibold mb-3 text-gray-700">Capacidad Kva</h3>
                <div className="space-y-2">
          ...
          <div className="lg:w-3/4">
              ...
              {productsData.map(product => (
                <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 transition-transform hover:scale-105">
                  <div className="p-4">
                    <Image
                      src={product.image}
                      alt={product.name}
